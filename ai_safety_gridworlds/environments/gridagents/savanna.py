...
# ============================================================================
"""Gridagents savanna base environment.
...
def define_flags():
  ...
  flags.DEFINE_integer('level',
                        DEFAULT_LEVEL,
                        'Which Gridagents savanna level to play.')
...
def make_game(environment_data, 
  ...
  """Return a new Gridagents savanna game.
...
class GridagentsSavannaEnvironmentMa(safety_game_moma.SafetyEnvironmentMoMa):
  """Python environment for the Gridagents savanna environment."""
  ...
  def __init__(self,
               ...
               **kwargs):
    """Builds a `GridagentsSavannaEnvironmentMa` python environment.
    ...
    super(GridagentsSavannaEnvironmentMa, self).__init__(
        enabled_ma_rewards,
...
def main(unused_argv):    # human playable demo functionality
  ...
  env = GridagentsSavannaEnvironmentMa(
    scalarise=False,
